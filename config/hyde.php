...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Crafton - zadanie rekrutacyjne'),
    ...
    */
    ...
    'meta' => [
        ...
        Meta::property('site_name', env('SITE_NAME', 'Crafton - zadanie rekrutacyjne')),
    ],
    ...
    */
    ...
    'footer' => 'Materiały zawarte na stronie WWW mają charakter poglądowy i nie mogą być traktowane jako ostateczne projekty realizacyjne. Deweloper zastrzega sobie prawo zmian. Niniejsza informacja nie stanowi oferty w rozumieniu przepisów Kodeksu Cywilnego i ma wyłącznie charakter informacyjny.',
    ...
    */
    ...
    'media_extensions' => array_merge(['woff', 'woff2', 'ttf'], \Hyde\Support\Filesystem\MediaFile::EXTENSIONS),
    ...
    'safe_output_directories' => ['_site', 'docs', 'build', 'public'],
